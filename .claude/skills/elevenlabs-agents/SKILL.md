...
description: Complete reference for configuring ElevenLabs Conversational AI agents — conversation_config (agent/prompt, tts, asr, turn, conversation), platform_settings (auth, call_limits, guardrails, privacy, widget), knowledge base/RAG, and CRUD via CLI/SDK/cURL. Use when creating, updating, or debugging ElevenLabs conversational agents, voice/TTS settings, turn-taking behavior, guardrails, or agent CI/CD pushes.
---
